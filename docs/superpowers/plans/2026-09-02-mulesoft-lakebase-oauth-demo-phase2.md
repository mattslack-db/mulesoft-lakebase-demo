...
- **Live workspace facts come from `infra/connection-facts.md`** (profile `mulesoft-lakebase-demo`, host `fe-sandbox-mulesoft-lakebase-demo.cloud.databricks.com`, Data API URL, SP client id `7a31531d-…`, PG host, `demo.customers`). The FEVM sandbox expires **2026-09-15** — extend via FEVM if needed.
